class Block{
    constructor(index, transmitter, receiver, message,fecha, previusHash, hash){
        this.index = index;
...
class BlockChain{
    ...
    async insert(transmitter, receiver, message, fecha){

        let newNode = new Block(this.size, transmitter, receiver, message, fecha, "","");
        if(this.head == null){
