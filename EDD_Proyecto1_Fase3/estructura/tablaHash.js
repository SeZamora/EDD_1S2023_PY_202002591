...
search(carnet, password){
    ...
    if(indice < this.capacidad){
        ...
        if(this.table[siguienteIndice] != null && this.table[siguienteIndice].password === password){
            return this.table[siguienteIndice];
        }
    }
    ...
    imprimirTabla() {
        ...
        for (let i = 0; i < this.table.length; i++) {
           if (this.table[i] != null){
                console.log("indice" + i + " Carnet: " + this.table[i].carnet);
                html +=`
            <tr>
